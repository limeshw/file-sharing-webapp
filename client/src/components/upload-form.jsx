          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            >
              ...
              <div className="flex flex-col gap-5 md:flex-row md:items-center">
                <div className={`flex size-14 items-center justify-center rounded-lg transition-colors duration-300 ${isDragging ? 'bg-primary text-primary-foreground shadow-md shadow-primary/20' : 'bg-primary/10 text-primary group-hover:bg-primary/20'}`}>
              ...
              {selectedFile ? (
                <div className="mt-6 flex items-center justify-between rounded-lg border border-border/60 bg-background/50 px-4 py-3 shadow-sm backdrop-blur-sm">
                  ...
                  <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">Selected</Badge>
                </div>
              ) : null}
            </button>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="space-y-3">
                <p className="text-sm font-semibold text-foreground">Link expires in</p>
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-2 text-sm font-semibold text-foreground" htmlFor="password">
                ...
                <Input
                  ...
                  className="rounded-lg h-10 bg-transparent"
            ...
            {isUploading ? (
              <div className="rounded-lg border border-border/50 bg-secondary/10 p-5">
            ...
            <Button type="submit" size="lg" className="w-full rounded-lg text-base font-semibold" disabled={isUploading}>
